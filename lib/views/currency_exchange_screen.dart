import 'package:currency_exchange/providers/currency_provider.dart';
...
class CurrencyExchangeScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<CurrencyExchangeScreen> createState() =>
      _CurrencyExchangeScreenState();
}

class _CurrencyExchangeScreenState
    extends ConsumerState<CurrencyExchangeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: currencyResponseAsyncValue.when(
        data: (data) {
